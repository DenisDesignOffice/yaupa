...
echo "Congratulations ".$nam1."! your submission was successful. <br/>";

echo "Please wait while your transaction is verified <br/>";
echo "We will send you your pin and serial number to the registered phone and email address";
     echo '</div>';
?>
 </div>
