<div id="transport_companiesDiv" style="display: block" class="modal">
            ...
            <input value="search" style="width:5%; height: 30px; margin-top: 2dp " type="submit" classname="search"  Placeholder="Search"></i>
                                <i class="fa fa-search"><input name="view" value="travel_bookings" style="width:20%; height: 30px; visibility: hidden" type="text" classname="search"  Placeholder="Search"></i>
...
//                    echo $rec_count;
                    ...
                    if (isset($_GET{'search'})) {
                        ...
                        $sql = "SELECT * FROM travel_bookings " . "LIMIT  $rec_limit OFFSET 0";
                    }
