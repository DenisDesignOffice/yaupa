    ...
    <div class="modal-content">
        ...
        <form style="margin-bottom: 10px;" name="myform1" method="get" action="./cpanel_dashboard.php"  >
            ...
            <input value="search" style="width:5%; height: 30px; margin-top: 2dp " type="submit" classname="search"  Placeholder="Search"></i>
                                <i class="fa fa-search"><input name="view" value="taxi_services" style="width:20%; height: 30px; visibility: hidden" type="text" classname="search"  Placeholder="Search"></i>
...
//                    echo $rec_count;
                    ...
                    if (isset($_GET{'search'})) {
                        ...
                        $sql = "SELECT * FROM taxi_services " . "LIMIT  $rec_limit OFFSET 0";
                    }
