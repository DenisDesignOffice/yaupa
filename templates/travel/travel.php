...
<body >
    ...
    <section class="form" style="padding-top: 2px">
        ...
        <form method="post" name="travel_form" id="travel_form" action="./travel.php">
            ...
            <input type="text" name="from1" value="<?php if (isset($_POST['from_home'])) echo $_POST['from_home']; ?>" placeholder="From ?  e.g lagos" class="input"></td>
            <input type="text" name="to1" value="<?php if (isset($_POST['from_home'])) echo $_POST['to_home']; ?>" placeholder="To ?  e.g bayelsa" class="input"></td>
